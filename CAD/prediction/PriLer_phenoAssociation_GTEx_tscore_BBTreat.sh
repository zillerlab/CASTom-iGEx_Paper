#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/pheno_BBTreat_tscore_%x_split%a.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/pheno_BBTreat_tscore_%x_split%a.err
#SBATCH --time=7-0
#SBATCH --nodes=1
...
${git_fold}pheno_association_tscore_largeData_run.R \
	...
	--names_file Blood_biochemistry_withMed Blood_count_withMed --inputFile ${fold}predictedTscores_splitGenes${SLURM_ARRAY_TASK_ID}.RData \
