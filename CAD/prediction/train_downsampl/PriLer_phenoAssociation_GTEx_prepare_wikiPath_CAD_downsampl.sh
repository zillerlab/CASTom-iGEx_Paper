#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/phenoAssociation_prepare_wiki_downs_%x.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/phenoAssociation_prepare_wiki_downs_%x.err
#SBATCH --time=7-0
#SBATCH --nodes=1
#SBATCH --mem=60G
