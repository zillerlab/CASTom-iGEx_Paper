...
${git_fold}/pheno_association_metaAnalysis_run.R \
	...
	--phenoName Dx --outFold ${TMPDIR}/tmp_CMC \
	--GOterms_file ${TMPDIR}/tmp_CMC/GOterm_geneAnnotation_allOntologies.RData \
	--reactome_file ${TMPDIR}/tmp_CMC/ReactomePathways.gmt \
	--cov_corr T \
