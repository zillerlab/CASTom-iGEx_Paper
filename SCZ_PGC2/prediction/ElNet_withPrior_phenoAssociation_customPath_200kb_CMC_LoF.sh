#!/bin/bash
#SBATCH -o /home/luciat/eQTL_PROJECT/err_out_fold/phenoAssociation_customPath_c%a_CMC_LoF.out
#SBATCH -e /home/luciat/eQTL_PROJECT/err_out_fold/phenoAssociation_customPath_c%a_CMC_LoF.err
#SBATCH -N 1
#SBATCH --mem=10G
#SBATCH -t 24:00:00
...
cp ${git_fold}refData/SCZ_LoF_GeneSets_ordered.RData ${TMPDIR}/tmp_${id_c}_CMC/
...
${git_fold}pheno_association_smallData_customPath_run.R \
	...
	--pathwayStructure_file ${TMPDIR}/tmp_${id_c}_CMC/SCZ_LoF_GeneSets_ordered.RData \
	--cov_corr T \
