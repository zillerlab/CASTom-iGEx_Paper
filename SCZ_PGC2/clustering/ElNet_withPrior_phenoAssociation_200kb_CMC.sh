...
Rscript RSCRIPTS/SCRIPTS_v2/AssociationAnalysis_PredVSPheno_v3_run.R --covDat_file INPUT_DATA/Covariates/${c}.covariateMatrix.txt --phenoDat_file INPUT_DATA/Covariates/${c}.phenoMatrix.txt --geneAnn_file ${TMPDIR}/tmp_${id_c}_CMC/resPrior_regEval_allchr.txt --inputFold ${TMPDIR}/tmp_${id_c}_CMC/ --outFold ${TMPDIR}/tmp_${id_c}_CMC/ --GOterms_file ${TMPDIR}/tmp_${id_c}_CMC/GOterm_geneAnnotation_allOntologies.RData --reactome_file ${TMPDIR}/tmp_${id_c}_CMC/ReactomePathways.gmt --cov_corr T --functR RSCRIPTS/SCRIPTS_v2/AssociationAnalysis_functions_run.R --sampleAnn_file INPUT_DATA/Covariates/${c}.covariateMatrix.txt --names_file SCZ_pheno --phenoAnn_file INPUT_DATA/Covariates/phenotypeDescription_PGCcohorts.csv
