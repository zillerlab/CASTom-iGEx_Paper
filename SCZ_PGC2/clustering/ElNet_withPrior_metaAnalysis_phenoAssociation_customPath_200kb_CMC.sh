...
Rscript RSCRIPTS/SCRIPTS_v2/MetaAnalysis_Association_v2_customGeneList_run.R --res_cohorts ${file_res[@]} --phenoDatFile_cohorts ${file_pheno[@]} --phenoName Dx --outFold ${TMPDIR}/tmp_CMC --pathwayStructure_file ${TMPDIR}/tmp_CMC/CMC_GeneSets_Hypothesis-driven-for-Enrichement.RData --geneSetName CMC_GeneSets  --cov_corr T --name_cohort ${name_cohorts[@]} --abs_tscore T
