...
cp ${fold_out}matchUKBB_filt0.1_tscore_corrPCs_zscaled_clusterCases_PGmethod_HKmetric_minimal.RData ${TMPDIR}/tmp_GTEx_t${id}/
cp ${fold_out}matchUKBB_tscore_corr2Thr0.1_risk_score_relatedPhenotypes.txt.gz ${TMPDIR}/tmp_GTEx_t${id}/

clust_file=${TMPDIR}/tmp_GTEx_t${id}/matchUKBB_filt0.1_tscore_corrPCs_zscaled_clusterCases_PGmethod_HKmetric_minimal.RData
...
Rscript ${git_fold}cluster_associatePhenoGLM_run.R \
	...
	--outFold ${TMPDIR}/tmp_GTEx_t${id}/matchUKBB_filt0.1_riskScores_ \
	--type_data tscore_corrPCs \
	--type_input zscaled \
	--risk_score T \
	--rescale_pheno T

cp ${TMPDIR}/tmp_GTEx_t${id}/matchUKBB_filt0.1_riskScores_*GLM* ${fold_out}
