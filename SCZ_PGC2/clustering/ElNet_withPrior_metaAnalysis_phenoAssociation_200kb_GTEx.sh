...
Rscript RSCRIPTS/SCRIPTS_v2/MetaAnalysis_Association_v2_run.R --res_cohorts ${file_res[@]} --phenoDatFile_cohorts ${file_pheno[@]} --phenoName Dx --outFold ${TMPDIR}/tmp_GTEx_${id_t}/ --GOterms_file ${TMPDIR}/tmp_GTEx_${id_t}/GOterm_geneAnnotation_allOntologies.RData --reactome_file ${TMPDIR}/tmp_GTEx_${id_t}/ReactomePathways.gmt --cov_corr T --name_cohort ${name_cohorts[@]}
