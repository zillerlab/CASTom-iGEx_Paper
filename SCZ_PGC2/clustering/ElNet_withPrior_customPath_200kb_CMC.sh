...
Rscript RSCRIPTS/SCRIPTS_v2/pathScore_customGeneList_run.R --sampleAnn_file INPUT_DATA/Covariates/${c}.covariateMatrix_old.txt --pathwayStruct_file ${TMPDIR}/tmp_${id_c}_CMC_path/CMC_GeneSets_Hypothesis-driven-for-Enrichement.RData  --tscore_file ${TMPDIR}/tmp_${id_c}_CMC_path/predictedTscores.txt --outFold ${TMPDIR}/tmp_${id_c}_CMC_path/ --geneSetName CMC_GeneSets --abs_tscore T
