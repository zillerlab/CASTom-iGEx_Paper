...
mkdir -p ${TMPDIR}/tmp_CMC_f
cp OUTPUT_CMC/predict_PGC/200kb/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/update_corrPCs/matchUKBB_filt0.1_tscore_corrPCs_zscaled_clusterCases_PGmethod_HKmetric.RData ${TMPDIR}/tmp_CMC_f/
...
# tscore
Rscript ${git_fold}cluster_associateFeat_corrPCs_multipleCohorts_run.R \
	...
	--type_data tscore \
	--type_input zscaled  \
	--outFold ${TMPDIR}/tmp_CMC_f/matchUKBB_filt0.1_ \
	--functR ${git_fold}clustering_functions.R \
	--clusterFile ${TMPDIR}/tmp_CMC_f/matchUKBB_filt0.1_tscore_corrPCs_zscaled_clusterCases_PGmethod_HKmetric.RData \
	--ncores 10 \
	--geneInfoFile ${gene_info[@]} \
	--pvalcorr_thr 0.01 

cp ${TMPDIR}/tmp_CMC_f/matchUKBB_filt0.1_tscoreOriginal*Cluster* OUTPUT_CMC/predict_PGC/200kb/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/update_corrPCs/

cp ${TMPDIR}/tmp_CMC_f/matchUKBB_filt0.1_*summary* OUTPUT_CMC/predict_PGC/200kb/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/update_corrPCs/

rm -r ${TMPDIR}/tmp_CMC_f/
