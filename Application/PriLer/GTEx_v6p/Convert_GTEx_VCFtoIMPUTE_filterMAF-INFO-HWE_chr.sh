...
do
	...
	/psycl/g/mpsziller/lucia/Software/software_denbi/PLINK2/plink2 --vcf $OUTPUT_FILE$chr'.vcf.gz' dosage=DS --recode oxford ref-first --out $OUTFOLD$OUTPUT_FILE$chr # use the first allele as reference
	...
	/psycl/g/mpsziller/lucia/Software/software_denbi/PLINK2/plink2 --gen $OUTFOLD$OUTPUT_FILE$chr'.gen' --sample $OUTFOLD$OUTPUT_FILE$chr'.sample' --recode oxford  --exclude ${OUTFOLD}var_toremove_chr${chr} --out $OUTFOLD$OUTPUT_FILE$chr'_filt'
