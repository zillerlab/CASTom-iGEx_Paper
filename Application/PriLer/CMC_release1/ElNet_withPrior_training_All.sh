...
# part2 
jid2=$(sbatch --job-name=${type_name}_p2 --parsable --dependency=afterany:${jid1} -c 5 --mem-per-cpu=40G -p pe ElNet_withPrior_part2_200kb.sh ${type_name} 5)
...
# part4
jid4=$(sbatch --job-name=${type_name}_p4 --parsable --dependency=afterany:${jid1}:${jid2}:${jid3} -c 50 --mem-per-cpu=4G -p pe ElNet_withPrior_part4_200kb.sh ${type_name} 50)
