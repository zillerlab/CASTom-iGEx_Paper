#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/err_out_fold/phenoAssociation_BP_BM_tscore_%x_split%a.out
#SBATCH -e /psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/err_out_fold/phenoAssociation_BP_BM_tscore_%x_split%a.err
#SBATCH --time=7-0
#SBATCH --nodes=1
...
${fold_git}pheno_association_tscore_largeData_run.R \
	...
	--inputFile OUTPUT_CMC/predict_UKBB/200kb/devgeno0.01_testdevgeno0/predictedTscores_splitGenes${SLURM_ARRAY_TASK_ID}.RData \
	--outFile OUTPUT_CMC/predict_UKBB/200kb/devgeno0.01_testdevgeno0/Association_tscore_res/pval_tscore_splitGene${SLURM_ARRAY_TASK_ID}_ \
	--cov_corr T \
