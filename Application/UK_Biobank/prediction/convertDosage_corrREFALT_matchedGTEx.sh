#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/err_out_fold/correctREF-ALT_convertDos_%x_%a.out
#SBATCH -e /psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/err_out_fold/correctREF-ALT_convertDos_%x_%a.err
#SBATCH --time=7-0
#SBATCH --nodes=1
#SBATCH --mem=15G
...
path_out=/psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/INPUT_DATA_GTEx/UKBB/Genotyping_data/

#########################
#### filter gen file ####
#########################

awk  'FNR>1 {print $2}' ${path_out}/Genotype_VariantsInfo_matchedGTEx_chr${id_chr}.txt > ${path_out}/var_tokeep_chr${id_chr}_split${id_split}
awk  'FNR>1 {print $2,$5}' ${path_out}/Genotype_VariantsInfo_matchedGTEx_chr${id_chr}.txt > ${path_out}/chr${id_chr}_ref_split${id_split}.txt
