#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/err_out_fold/PathScore_customPath_CMC_%x.out
#SBATCH -e /psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/err_out_fold/PathScore_customPath_CMC_%x.err
#SBATCH --time=7-0
#SBATCH --nodes=1
