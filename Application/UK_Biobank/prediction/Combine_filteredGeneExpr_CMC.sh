#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/err_out_fold/combinePredExpr_CMC_filtGenes.out
#SBATCH -e /psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/err_out_fold/combinePredExpr_CMC_filtGenes.err
#SBATCH --time=7-0
#SBATCH --nodes=1
#SBATCH --mem=40G


cd /psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/OUTPUT_CMC/predict_UKBB/200kb/
gene_info=/psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/OUTPUT_CMC/train_CMC/200kb/resPrior_regEval_allchr.txt
testdevgeno=0
devgeno=0.01
