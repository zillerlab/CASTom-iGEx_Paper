...
path_out=/psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/INPUT_DATA_CMC/UKBB/Genotyping_data/

#########################
#### filter gen file ####
#########################

awk  'FNR>1 {print $2}' ${path_out}/Genotype_VariantsInfo_matchedCMC_chr${id_chr}.txt > ${path_out}/var_tokeep_chr${id_chr}_split${id_split}
awk  'FNR>1 {print $2,$5}' ${path_out}/Genotype_VariantsInfo_matchedCMC_chr${id_chr}.txt > ${path_out}/chr${id_chr}_ref_split${id_split}.txt
