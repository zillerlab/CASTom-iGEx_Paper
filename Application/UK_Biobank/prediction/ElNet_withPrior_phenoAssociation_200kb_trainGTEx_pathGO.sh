...
${git_fold}pheno_association_pathscore_largeData_run.R --inputInfoFile OUTPUT_GTEx/predict_UKBB/${t}/200kb/noGWAS/devgeno0.01_testdevgeno0/pathScore_GO_info.RData --covDat_file ${cov_file[@]} --phenoDat_file ${dat_file[@]} --names_file ${name_file[@]}  --inputFile OUTPUT_GTEx/predict_UKBB/${t}/200kb/noGWAS/devgeno0.01_testdevgeno0/Pathway_GO_scores_splitPath${SLURM_ARRAY_TASK_ID}.RData --outFile OUTPUT_GTEx/predict_UKBB/${t}/200kb/noGWAS/devgeno0.01_testdevgeno0/Association_GO_res/pval_pathScore_GO_splitPath${SLURM_ARRAY_TASK_ID}_ --cov_corr T --sampleAnn_file INPUT_DATA/Covariates/covariatesMatrix.txt --ncores 10 --phenoAnn_file INPUT_DATA/Covariates/phenotypeDescription_PHESANTproc.txt --functR ${git_fold}pheno_association_functions.R   --path_type GO
