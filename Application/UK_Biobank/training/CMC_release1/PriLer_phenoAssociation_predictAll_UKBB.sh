...
#SBATCH --output=/psycl/g/mpsziller/lucia/PriLer_PROJECT_CMC/err_out_fold/phenoAssoc_All_UKBB.out
#SBATCH --error=/psycl/g/mpsziller/lucia/PriLer_PROJECT_CMC/err_out_fold/phenoAssoc_All_UKBB.err
#SBATCH --mem=30G
#SBATCH -c 1
#SBATCH -p hp
...
${git_fold}pheno_association_smallData_run.R \
    ...
    --inputFold ${fold}predict_All/devgeno0.01_testdevgeno0/ \
