...
mkdir -p "${l}/OUTPUT_CAD/predict_CAD/${t}/200kb/CAD_GWAS_bin5e-2_nogwas/${cohort}"
...
${g}/PriLer_predictGeneExp_run.R \
  ...
  --outFold "${l}/OUTPUT_CAD/predict_CAD/${t}/200kb/CAD_GWAS_bin5e-2_nogwas/${cohort}/" \
  --outTrain_fold "${l}/PriLer_PROJECT_GTEx/OUTPUT_SCRIPTS_v2_CAD_UKBB/${t}/200kb/CAD_GWAS_bin5e-2_nogwas/" \
