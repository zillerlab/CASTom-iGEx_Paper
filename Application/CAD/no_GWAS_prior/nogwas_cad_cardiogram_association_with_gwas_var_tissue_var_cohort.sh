...
${g}/Software/model_prediction/pheno_association_smallData_run.R \
  ...
  --geneAnn_file "${l}/PriLer_PROJECT_GTEx/OUTPUT_SCRIPTS_v2_CAD_UKBB/${t}/200kb/CAD_GWAS_bin5e-2/resPrior_regEval_allchr.txt" \
  --inputFold "${l}/OUTPUT_CAD/predict_CAD/${t}/200kb/CAD_GWAS_bin5e-2/${cohort}/devgeno0.01_testdevgeno0/" \
  --outFold "${l}/OUTPUT_CAD/predict_CAD/${t}/200kb/CAD_GWAS_bin5e-2/${cohort}/devgeno0.01_testdevgeno0/" \
