...
mkdir -p "${l}/${t}/200kb/CAD_GWAS_bin5e-2/${cohort}/devgeno0.01_testdevgeno0/"

${g}/Software/model_prediction/Tscore_PathScore_diff_run.R \
  --covDat_file "${c}/Covariates/${cohort}/covariateMatrix.txt" \
  --input_file "${l}/${t}/200kb/CAD_GWAS_bin5e-2/${cohort}/predictedExpression.txt.gz" \
  --outFold "${l}/${t}/200kb/CAD_GWAS_bin5e-2/${cohort}/devgeno0.01_testdevgeno0/" \
  --nFolds 40 \
...
${g}/Software/model_prediction/pathScore_customGeneList_run.R \
  ...
  --tscore_file "${l}/${t}/200kb/CAD_GWAS_bin5e-2/${cohort}/devgeno0.01_testdevgeno0/predictedTscores.txt" \
  --outFold "${l}/${t}/200kb/CAD_GWAS_bin5e-2/${cohort}/devgeno0.01_testdevgeno0/" \
