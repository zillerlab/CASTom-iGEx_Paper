...
${git_fold}cluster_associatePhenoGLM_run.R \
	...
	--type_sim HK \
	--clusterFile ${fold}tscore_corrPCs_original_clusterControls_PGmethod_HKmetric.RData \
	--rescale_pheno T
...
${git_fold}plot_endophenotype_grVSall_run.R \
    ...
    --type_cluster Controls \
	--type_input corrPCs_original \
	--endopFile ${fold}rescaleCont_withMedication_tscore_corrPCs_original_clusterControls_PGmethod_HKmetric_phenoAssociation_GLM.RData ${fold}rescaleCont_withoutMedication_tscore_corrPCs_original_clusterControls_PGmethod_HKmetric_phenoAssociation_GLM.RData \
	--outFold ${fold} \
	--forest_plot T \
	--pval_pheno 0.001 \
