#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/cluster_controls_tscore_CAD_original_corrPCs_t%a_featRelTscore.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/cluster_controls_tscore_CAD_original_corrPCs_t%a_featRelTscore.err
#SBATCH --time=11-0
#SBATCH --nodes=1
...
${git_fold}cluster_associateFeat_corrPCs_run.R \
	...
	--outFold ${fold_cl}ClusterOriginal_ \
	--functR ${git_fold}clustering_functions.R \
	--type_input original \
	--clusterFile ${fold_cl}tscore_corrPCs_original_clusterControls_PGmethod_HKmetric.RData \
