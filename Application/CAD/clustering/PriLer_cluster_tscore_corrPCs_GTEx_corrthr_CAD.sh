#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/cluster_tscore_corrPCs_CAD_corrthr_t%a_%x.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/cluster_tscore_corrPCs_CAD_corrthr_t%a_%x.err
#SBATCH --time=7-0
#SBATCH --nodes=1
#SBATCH --mem=50G
...
mkdir -p ${fold}CAD_HARD_clustering/update_corrPCs/variable_corrthr/
...
${git_fold}cluster_PGmethod_corrPCs_run.R \
	...
	--type_data tscore \
	--type_cluster Cases \
	--outFold ${fold}CAD_HARD_clustering/update_corrPCs/variable_corrthr/corrthr${thr}_ \
