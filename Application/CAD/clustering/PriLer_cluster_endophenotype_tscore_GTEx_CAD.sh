#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/cluster_tscore_pheno_CAD_t%a_%x.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/cluster_tscore_pheno_CAD_t%a_%x.err
#SBATCH --time=7-0
#SBATCH --nodes=1
#SBATCH --mem=20G
...
${git_fold}cluster_associatePhenoGLM_run.R \
	...
	--type_input zscaled \
	--type_sim HK \
	--clusterFile ${fold}tscore_zscaled_clusterCases_PGmethod_HKmetric.RData \
	--rescale_pheno T
...
${git_fold}plot_endophenotype_grVSall_run.R \
    ...
    --type_cluster Cases \
	--type_input zscaled \
	--endopFile ${fold}rescaleCont_withMedication_tscore_zscaled_clusterCases_PGmethod_HKmetric_phenoAssociation_GLM.RData ${fold}rescaleCont_withoutMedication_tscore_zscaled_clusterCases_PGmethod_HKmetric_phenoAssociation_GLM.RData \
	--outFold ${fold} \
	--forest_plot T \
	--pval_pheno 0.001 \
