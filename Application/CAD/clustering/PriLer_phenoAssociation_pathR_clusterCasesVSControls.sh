#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/pheno_cluster_pathR_%x_split%a.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/pheno_cluster_pathR_%x_split%a.err
#SBATCH --time=7-0
#SBATCH --nodes=1
...
mkdir -p OUTPUT_GTEx/predict_CAD/${tissue_cl}/200kb/CAD_GWAS_bin5e-2/UKBB/devgeno0.01_testdevgeno0/CAD_HARD_clustering/update_corrPCs/cluster_specific_PALAS/${tissue_considered}/Association_reactome_res/
...
${git_fold}pheno_association_pathscore_largeData_run.R \
	--inputInfoFile ${fold_data}pathScore_Reactome_info.RData \
	...
	--inputFile ${fold_data}Pathway_Reactome_scores_splitPath${SLURM_ARRAY_TASK_ID}.RData \
	--outFile  ${fold_cl}/${tissue_considered}/Association_reactome_res/pval_pathScore_Reactome_splitPath${SLURM_ARRAY_TASK_ID}_ \
	--cov_corr T \
