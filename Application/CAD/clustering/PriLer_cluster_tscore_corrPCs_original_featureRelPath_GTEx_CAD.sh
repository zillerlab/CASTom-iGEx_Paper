#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/cluster_tscore_CAD_original_corrPCs_t%a_featRelPath.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/cluster_tscore_CAD_original_corrPCs_t%a_featRelPath.err
#SBATCH --time=1-0
#SBATCH --nodes=1
...
${git_fold}cluster_associatePath_corrPCs_run.R \
	...
	--type_input original \
	--clusterFile ${fold_cl}tscore_corrPCs_original_clusterCases_PGmethod_HKmetric.RData \
