#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/PRS_%x_featRelTscore.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/PRS_%x_featRelTscore.err
#SBATCH --time=1-0
#SBATCH --nodes=1
...
${git_fold}cluster_associateFeat_corrPCs_run.R \
	...
	--type_input PRS_${name} \
	--clusterFile ${fold_cl}PRS_CAD_UKBB_Cases_${name}.RData \
	--type_data_cluster PRS_${name} \
	--ncores 11 \
	--tissues ${tissues_tot[@]} \
	--pvalcorr_thr 0.01
