#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/pheno_cluster_wiki_%x.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/pheno_cluster_wiki_%x.err
#SBATCH --time=7-0
#SBATCH --nodes=1
...
mkdir -p OUTPUT_GTEx/predict_CAD/${tissue_cl}/200kb/CAD_GWAS_bin5e-2/UKBB/devgeno0.01_testdevgeno0/CAD_HARD_clustering/update_corrPCs/cluster_specific_PALAS/${tissue_considered}/Association_WikiPath2019Human_res/
...
${git_fold}pheno_association_pathscore_largeData_run.R \
	--inputInfoFile ${fold_data}pathScore_WikiPath2019Human_info.RData \
	...
	--inputFile ${fold_data}Pathway_WikiPath2019Human_scores_splitPath1.RData \
	--outFile  ${fold_cl}/${tissue_considered}/Association_WikiPath2019Human_res/pval_pathScore_WikiPath2019Human_splitPath1_ \
	--cov_corr T \
