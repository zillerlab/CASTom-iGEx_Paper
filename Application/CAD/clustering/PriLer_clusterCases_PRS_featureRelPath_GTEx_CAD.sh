#!/bin/bash
#SBATCH -o /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/PRS_%x_featRelPath.out
#SBATCH -e /psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/err_out_fold/PRS_%x_featRelPath.err
#SBATCH --time=1-0
#SBATCH --nodes=1
