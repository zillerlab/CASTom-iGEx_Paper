...
rm tmp_chr${id_chr} tmp_chr${id_chr}_snps tmp_chr${id_chr}_dupes tmp_chr${id_chr}_uniq chr${id_chr}.txt chr${id_chr}_snps_correct.txt chr${id_chr}_indels_correct.txt
