...
cp OUTPUT_CMC/predict_PGC/200kb/${c}/devgeno0.01_testdevgeno0/predictedTscores.txt ${TMPDIR}/tmp_CMC_t/
...
input_file=${TMPDIR}/tmp_CMC_t/predictedTscores.txt
...
./${git_fold}cluster_PGmethod_corrPCs_predict_run.R \
	...
	--clustFile ${TMPDIR}/tmp_CMC_t/matchUKBB_tscore_corrPCs_zscaled_clusterCases_PGmethod_HKmetric.RData \
	--type_data tscore \
	--type_input zscaled \
...
cp ${TMPDIR}/tmp_CMC_t/matchUKBB_*predict* OUTPUT_CMC/predict_PGC/200kb/${c}/devgeno0.01_testdevgeno0/update_corrPCs/
