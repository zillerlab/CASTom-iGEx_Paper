...
extra_pathway_list <- data.frame(path = c("Cytokines and Inflammatory Response WP530",
                        ...
                        tissue = c("Brain_Cerebellum", "Brain_Cerebellar_Hemisphere", 
...
input_spider <- cbind(input_spider_1$mean, input_spider_2$mean[,-1])
keep_pathways_tissues <- c(input_spider_1$pathways, input_spider_2$pathways)
input_spider
