...
${git_fold}compute_risk_score_corrPCs_multipleCohorts_run.R \
	...
	--type_data tscore \
	--sqcorr_thr 0.1 \
	--outFold ${TMPDIR}/matchUKBB_allSamples_ \
...
cp ${TMPDIR}/matchUKBB_allSamples_*risk_score* OUTPUT_CMC/predict_PGC/200kb/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/update_corrPCs/
