...
cp ${TMPDIR}/tmp_CMC_t/matchUKBB_customPath_CMC_GeneSetsOriginal*Cluster* OUTPUT_CMC/predict_PGC/200kb/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/update_corrPCs/
