#!/bin/bash
#SBATCH -o /home/luciat/eQTL_PROJECT/err_out_fold/cluster_tscore_zscaled_GTEx_t%a_%x_matchUKBB.out
#SBATCH -e /home/luciat/eQTL_PROJECT/err_out_fold/cluster_tscore_zscaled_GTEx_t%a_%x_matchUKBB.err
#SBATCH -N 1
#SBATCH --mem=90G
#SBATCH -t 120:00:00
...
cp OUTPUT_all/matchUKBB_samples_to_remove_outliersUMAP_tscore_corrPCs_zscaled_clusterCases.txt ${TMPDIR}/tmp_GTEx_tscore_t${id}/
...
Rscript ${git_fold}cluster_PGmethod_corrPCs_multipleCohorts_run.R \
	...
	--sampleOutFile ${TMPDIR}/tmp_GTEx_tscore_t${id}/matchUKBB_samples_to_remove_outliersUMAP_tscore_corrPCs_zscaled_clusterCases.txt \
	--genes_to_filter compare_prediction_UKBB_SCZ-PGC/${t}_filter_genes_matched_datasets.txt

cp ${TMPDIR}/tmp_GTEx_tscore_t${id}/matchUKBB*corrPCs*cluster* OUTPUT_GTEx/predict_PGC/${t}/200kb/PGC_GWAS_bin1e-2/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/update_corrPCs/
