#!/bin/bash
#SBATCH -o /home/luciat/eQTL_PROJECT/err_out_fold/detectOutliers_tscore_zscaled_CMC_matchUKBB.out
#SBATCH -e /home/luciat/eQTL_PROJECT/err_out_fold/detectOutliers_tscore_zscaled_CMC_matchUKBB.err
#SBATCH -N 1
#SBATCH -t 24:00:00
#SBATCH --mem=40G
...
cp ${TMPDIR}/tmp_CMC_t/matchUKBB*cluster* OUTPUT_CMC/predict_PGC/200kb/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/update_corrPCs/
