...
cp OUTPUT_CMC/predict_PGC/200kb/${c}/devgeno0.01_testdevgeno0/update_corrPCs/matchUKBB_tscore_corrPCs_zscaled_predictClusterCases_PGmethod_HKmetric.RData ${TMPDIR}/tmp_CMC/
...
Rscript ${git_fold}cluster_associateFeat_corrPCs_run.R \
	...
	--type_data tscore \
	--type_cluster Cases \
	--outFold ${TMPDIR}/tmp_CMC/matchUKBB_ \
	--functR ${git_fold}clustering_functions.R \
	--type_input zscaled \
	--clusterFile ${TMPDIR}/tmp_CMC/matchUKBB_tscore_corrPCs_zscaled_predictClusterCases_PGmethod_HKmetric.RData \
	--type_data_cluster tscore \
	--ncores 10 \
	--tissues ${tissues_tot[@]}

cp ${TMPDIR}/tmp_CMC/matchUKBB_*Original* OUTPUT_CMC/predict_PGC/200kb/${c}/devgeno0.01_testdevgeno0/update_corrPCs/
