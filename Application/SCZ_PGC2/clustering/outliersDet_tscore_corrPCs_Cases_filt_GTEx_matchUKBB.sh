...
${git_fold}detect_outliers_corrPCs_multipleCohorts_run.R \
	...
	--corr_thr 0.1 \
	--type_input zscaled \
	--outFold ${TMPDIR}/tmp_GTEx_tscore_t${id}/matchUKBB_filt0.1_ \
...
cp ${TMPDIR}/tmp_GTEx_tscore_t${id}/matchUKBB_filt0.1*cluster* OUTPUT_GTEx/predict_PGC/${t}/200kb/PGC_GWAS_bin1e-2/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/update_corrPCs/
