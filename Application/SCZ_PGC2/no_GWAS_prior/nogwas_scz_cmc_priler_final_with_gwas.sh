...
${g}/PriLer_finalOutput_run.R \
  ...
  --outFold "${l}/OUTPUT_SCZ-PGC_SCRIPTS_v2/train_All/200kb/PGC_GWAS_bin1e-2/" \
  --InfoFold "${c}/OUTPUT_SCZ-PGC_SCRIPTS_v2/" \
  --functR "${g}/PriLer_functions.R" \
  --part1Res_fold "${l}/OUTPUT_SCZ-PGC_SCRIPTS_v2/train_All/200kb/" \
  --part2Res_fold "${l}/OUTPUT_SCZ-PGC_SCRIPTS_v2/train_All/200kb/PGC_GWAS_bin1e-2/" \
  --part3Res_fold "${l}/OUTPUT_SCZ-PGC_SCRIPTS_v2/train_All/200kb/PGC_GWAS_bin1e-2/" \
  --part4Res_fold "${l}/OUTPUT_SCZ-PGC_SCRIPTS_v2/train_All/200kb/PGC_GWAS_bin1e-2/" \
