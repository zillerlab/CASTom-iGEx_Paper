#!/bin/bash
#SBATCH -o /home/luciat/eQTL_PROJECT/err_out_fold/convert_dosage_GTEx_%x_chr%a.out
#SBATCH -e /home/luciat/eQTL_PROJECT/err_out_fold/convert_dosage_GTEx_%x_chr%a.err
#SBATCH -N 1
#SBATCH --mem=10G
#SBATCH -t 5:00:00
...
output_dir=/home/luciat/eQTL_PROJECT/INPUT_DATA_GTEx/SCZ-PGC/Genotype_data/
